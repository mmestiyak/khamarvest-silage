...
const CONTEXT = {
  ...
  north: (d) => `কৃষিপ্রধান ${d.name} অঞ্চলে গরু পালন ও মোটাতাজাকরণ দুটোই জনপ্রিয়। খড়ের দাম যেখানে ১৫-২০ টাকা কেজি, সেখানে ১০ টাকা কেজির ভুট্টা সাইলেজ দিয়ে খাদ্য খরচ নামিয়ে আনা যায়।`,
...
const districts = [
  { name: 'বগুড়া', loc: 'বগুড়ায়', slug: 'bogura', en: 'Bogura', division: 'রাজশাহী', near: ['natore', 'sirajganj', 'rangpur'], ctx: 'north' },
  ...
  { name: 'নাটোর', loc: 'নাটোরে', slug: 'natore', en: 'Natore', division: 'রাজশাহী', near: ['pabna', 'bogura', 'sirajganj'], ctx: 'general' },
  { name: 'রংপুর', loc: 'রংপুরে', slug: 'rangpur', en: 'Rangpur', division: 'রংপুর', near: ['dinajpur', 'bogura'], ctx: 'north' },
  { name: 'দিনাজপুর', loc: 'দিনাজপুরে', slug: 'dinajpur', en: 'Dinajpur', division: 'রংপুর', near: ['rangpur'], ctx: 'north' },
  { name: 'ময়মনসিংহ', loc: 'ময়মনসিংহে', slug: 'mymensingh', en: 'Mymensingh', division: 'ময়মনসিংহ', near: ['tangail', 'gazipur'], ctx: 'general' },
  ...
  { name: 'খুলনা', loc: 'খুলনায়', slug: 'khulna', en: 'Khulna', division: 'খুলনা', near: ['jashore', 'satkhira'], ctx: 'coastal' },
  { name: 'সাতক্ষীরা', loc: 'সাতক্ষীরায়', slug: 'satkhira', en: 'Satkhira', division: 'খুলনা', near: ['khulna', 'jashore'], ctx: 'coastal' },
  { name: 'কুমিল্লা', loc: 'কুমিল্লায়', slug: 'cumilla', en: 'Cumilla', division: 'চট্টগ্রাম', near: ['noakhali'], ctx: 'general' },
