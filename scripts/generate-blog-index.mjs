...
const toolPages = ['/tools/', '/tools/dudher-labh-calculator', '/tools/motatajakoron-khoroch-calculator', '/tools/khamar-shastho-checklist', '/tools/delivery-challan', '/tools/gorur-ojon-mapar-chart', '/tools/khaddo-talika-chart', '/tools/tika-krimi-calendar', '/tools/hishab-khata'];
