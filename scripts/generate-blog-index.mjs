...
for (const file of files) {
  ...
  posts.push({ file, url: `/${file.replace(/\.html$/, '')}`, title, description, date });
}
...
const excluded = new Set(['index.html', rootPost, 'gmb-cover-photo.html', 'guide-book.html']);
