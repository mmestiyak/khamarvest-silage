...
const toolPages = ['/tools/', '/tools/dudher-labh-calculator', '/tools/motatajakoron-khoroch-calculator', '/tools/khaddo-talika-chart', '/tools/tika-krimi-calendar', '/tools/hishab-khata'];
const sitemapUrls = ['/', ...posts.map((post) => post.url), ...toolPages];
